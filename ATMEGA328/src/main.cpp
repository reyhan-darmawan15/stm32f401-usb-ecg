...
volatile static int16_t adc2l, adc2h;
volatile static int16_t U[8], D[8];
volatile static int8_t isDACChanged[8] = { 0, 0, 0, 0, 0, 0, 0, 0};  // +1 = increment, -1 = decrement
